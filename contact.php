...
<html lang="en">
 <head>
     <title>Dusan Matic: Responsive Website</title>
  <meta charset="utf-8" />
 ...
 <body>
     ...
     <h1>Dusan Matic</h1>
        <nav class="topnav" id="myTopnav">
            ...
            <a href="web150/timeofday/" target="_blank">Time Of Day</a>
            <a href="web-150/daily/template6.html" target="_blank">Daily Grind</a>
            <a href="web-150/domplay/events7.html" target="_blank">DOM Play</a>
     ...
     -->  
       ...
       if(isset($_POST['Name'])){//show data
           echo '<pre>';
            ...
            $to  = 'dusanmatic@gmail.com';//put your email here
